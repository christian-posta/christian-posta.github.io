...
* Envoy will do automatic exponential retry with jittering. See [the docs for more](https://www.envoyproxy.io/docs/envoy/latest/configuration/http_filters/router_filter.html)
